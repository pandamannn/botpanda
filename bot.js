...
client.on('guildBanAdd' , (guild, user) => {
  ...
  aramızakatılanlar.send('https://media.giphy.com/media/8njotXALXXNrW/giphy.gif Yarrama bak hele '+ user.username +'Hadi kalk sikitir git :fist: :writing_hand:  :spy:' );
});
    ...
    if (user) {
      ...
      if (member) {
        ...
        member.ban({
          ...
          // either due to missing permissions or role hierarchy
          message.reply('Oh wait Bu galiba amdin!');
          // Log the error
          console.error(err);
        });
      } else {
